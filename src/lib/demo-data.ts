...
export const demoData: DemoDataBundle = {
  ...
  transactions: [
    { id: "txn-bookcase", listingId: "listing-bookcase-1", buyerId: "user-omar", sellerId: "user-sanne", state: "completed", meetupSpot: "University Library front steps", meetupWindow: "March 30, 18:00", completedAt: "2026-03-30T18:30:00.000Z" },
    { id: "txn-chair", listingId: "listing-chair-1", buyerId: "user-omar", sellerId: "user-lina", state: "reserved", meetupSpot: "UM Sports entrance", meetupWindow: "April 3, 14:00" }
  ],
  reviews: [
