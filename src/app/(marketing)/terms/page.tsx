...
export default function TermsPage() {
  return (
    <div className="mx-auto max-w-5xl space-y-8 px-6 py-16">
      ...
      <Card className="bg-white"><CardContent className="space-y-4 p-8 text-sm leading-7 text-slate-600"><p>Sellers must accurately describe item condition, pickup expectations, and known defects.</p><p>Buyers and sellers should keep communication respectful and follow meetup guidance in-app.</p><p>CampusSwap may hide, remove, or review listings and accounts that appear deceptive, unsafe, or outside the student-only community rules.</p></CardContent></Card>
    </div>
  );
}
